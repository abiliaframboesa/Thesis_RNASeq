# Remover maps de Kegg_Pathways porque estavam repetidos (eram iguais aos ko) e em vez de separar GO em GO_BP, GO_MF, GO_CC 
# manter apenas a coluna como sendo GO porque a informação estava repetida
...
entrada = "anotacoes_normalizadas.xlsx"
